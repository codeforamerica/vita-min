...
#
# ~~~IF THE PDF IS CHANGING IN A MEANINGFUL WAY~~~ have a PM or whoever is acceptance testing your
# story look at the new PDF fixtures generated by this task. You can point them to the PR,
# which lets you view PDFs if you click "..." -> "View file"
# ~~~EITHER WAY~~~ look at the new fixtures yourself before committing them. Even if there are
# no "meaningful" changes you should make sure it doesn't look any different.
STATE_PERSONAS = {
