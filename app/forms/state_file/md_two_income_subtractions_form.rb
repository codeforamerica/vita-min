  ...
  class MdTwoIncomeSubtractionsForm < QuestionsForm
    ...
    def valid_amounts
      if @intake.direct_file_data.fed_student_loan_interest.present?
        if (primary_student_loan_interest_ded_amount.to_f + spouse_student_loan_interest_ded_amount.to_f).round != @intake.direct_file_data.fed_student_loan_interest.to_f.round
          errors.add(
