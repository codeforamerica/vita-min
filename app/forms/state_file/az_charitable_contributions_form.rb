module StateFile
  class AzCharitableContributionsForm < QuestionsForm
    ...
    validates_numericality_of :charitable_cash, only_integer: true, message: I18n.t('errors.messages.whole_number')
    ...
    validates_numericality_of :charitable_noncash, only_integer: true, message: I18n.t('errors.messages.whole_number')
