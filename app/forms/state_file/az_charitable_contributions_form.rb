module StateFile
  class AzCharitableContributionsForm < QuestionsForm
    ...
    validates :charitable_cash, presence: true, gyr_numericality: { only_integer: true, greater_than_or_equal_to: 0 }, allow_blank: false, if: -> { charitable_contributions == "yes" }
    validates :charitable_noncash, presence: true, gyr_numericality: { only_integer: true, greater_than_or_equal_to: 0, less_than_or_equal_to: 500 }, allow_blank: false, if: -> { charitable_contributions == "yes" }
