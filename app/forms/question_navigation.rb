class QuestionNavigation
  FLOW = [
    ...
    Questions::Form1099dashgsController,
    ...
    Questions::FormIrastatementsController,
    Questions::FormPropertyTaxStatementsController,
    Questions::FormRrb1099sController,
    Questions::FormSsnItinsController,
    Questions::FormSsa1099sController,
    Questions::FormStudentAccountStatementsController,
    Questions::FormW2gsController,
    Questions::Form2018ReturnsController,
