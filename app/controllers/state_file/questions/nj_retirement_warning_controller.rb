  ...
  module Questions
    class NjRetirementWarningController < QuestionsController
      ...
      def self.show?(intake)
        line_14 = intake.calculator.line_or_zero(:NJ_1040_LINE_14)
        ...
        nj_retirement_income_helper.show_retirement_income_warning?(line_14, line_15, line_16a) && Flipper.enabled?(:show_retirement_ui)
      end
    end
  end
end
