class Ctc::Portal::PagesController < Ctc::Portal::BaseAuthenticatedController
  def no_eligible_dependents
    ...
    redirect_to Ctc::Portal::PortalController.to_path_helper(action: :edit_info) unless no_eligible_ctc_dependents || (!benefits.claiming_and_qualified_for_eitc? && open_for_eitc_intake?)
