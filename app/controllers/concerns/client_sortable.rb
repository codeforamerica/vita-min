module ClientSortable
  ...
  def filtered_clients
    ...
    clients = clients.where(with_general_navigator: true).or(clients.where(with_incarcerated_navigator: true)).or(clients.where(with_limited_english_navigator: true)).or(clients.where(with_unhoused_navigator: true)) if @filters[:used_navigator].present?
