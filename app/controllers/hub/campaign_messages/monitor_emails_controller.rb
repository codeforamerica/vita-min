module Hub
  module CampaignMessages
    class MonitorEmailsController < Hub::BaseController
      layout "hub"
      ...
      def chart_data
        render json: {
          kpis: {
            total: scoped_emails.count,
            succeeded: scoped_emails.succeeded.count,
            failed: scoped_emails.failed.count,
            in_progress: scoped_emails.in_progress.count,
          },
