module Hub
  class SubOrganizationsController < ApplicationController
    ...
    def update
      ...
      if @form.valid?
        @form.save
        redirect_to hub_vita_partner_path(id: @vita_partner.id)
      else
        render :edit
      end
    end
    ...
    def form_params
      params.require(:hub_sub_organization_form).permit(SubOrganizationForm.attribute_names).merge(parent_organization_id: @vita_partner.id)
    end
  end
end
