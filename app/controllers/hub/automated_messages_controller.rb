  ...
  class AutomatedMessagesController < Hub::BaseController
    ...
    def messages_preview
      ...
      emails = {
        ...
        "UserMailer.incoming_interaction_notification_email [signed_8879]" => UserMailer.incoming_interaction_notification_email(client: Client.last, received_at: Time.now, user: User.last, interaction_count: 2, interaction_type: "signed_8879", tax_return: TaxReturn.last),
