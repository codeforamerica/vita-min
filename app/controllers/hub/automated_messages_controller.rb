  ...
  class AutomatedMessagesController < Hub::BaseController
    ...
    def messages_preview
      ...
      emails = {
        ...
        "VerificationCodeMailer.previous_year_verification_code" => VerificationCodeMailer.previous_year_verification_code(to: "example@example.com", locale: :en, verification_code: '000000'),
