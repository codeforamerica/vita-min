  ...
  class AutomatedMessagesController < Hub::BaseController
    ...
    def messages_preview
      ...
      emails = {
        ...
        "UserMailer.internal_interaction_notification_email [tagged_in_note]" => UserMailer.internal_interaction_notification_email(user: User.last, interaction_type: "tagged_in_note"),
