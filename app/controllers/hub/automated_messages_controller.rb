  ...
  class AutomatedMessagesController < Hub::BaseController
    ...
    def messages_preview
      ...
      emails = {
        ...
        "VerificationCodeMailer.with_code_fyst" => VerificationCodeMailer.with(to: "example@example.com", locale: :en, service_type: :gyr, verification_code: '000000').with_code_fyst,
