  ...
  class AutomatedMessagesController < Hub::BaseController
    ...
    def messages_preview
      ...
      emails = {
        ...
        "UserMailer.incoming_interaction_notification_email" => UserMailer.incoming_interaction_notification_email(client: Client.last, message_sent_at: Time.now, user: User.last),
