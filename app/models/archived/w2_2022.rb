...
# Indexes
#
#  index_archived_w2s_2022_on_archived_intakes_2022_id  (archived_intakes_2022_id)
#  index_archived_w2s_2022_on_creation_token            (creation_token)
#
class Archived::W22022 < ApplicationRecord
  self.table_name = 'archived_w2s_2022'

  BOX12_OPTIONS = ["A", "B", "C", "D", "E", "F", "G", "H", "J", "K", "L", "M", "N", "P", "Q", "R", "S", "T", "V", "W", "Y", "Z", "AA", "BB", "DD", "EE", "FF", "GG", "HH"]
  BOX12_OFFBOARD_CODES = %w(A B K L M N R V W Z)

  belongs_to :intake, foreign_key: 'archived_intakes_2022_id', class_name: 'Archived::Intake2022'
  has_one :archived_w2_state_fields_groups_2022, dependent: :destroy
  has_one :archived_w2_box14s_2022, dependent: :destroy

  accepts_nested_attributes_for :archived_w2_state_fields_groups_2022, update_only: true
  accepts_nested_attributes_for :archived_w2_box14s_2022, update_only: true
