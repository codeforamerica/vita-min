...
class Archived::Dependent2022 < ApplicationRecord
  self.table_name = 'archived_dependents_2022'
  include SoftDeletable
  belongs_to :intake, inverse_of: :dependents, foreign_key: 'archived_intakes_2022_id', class_name: 'Archived::Intake2022'
  ...
  def mixpanel_data
    {
      dependent_age_at_end_of_tax_year: age_during(2022).to_s,
      dependent_under_6: age_during(2022) < 6 ? "yes" : "no",
