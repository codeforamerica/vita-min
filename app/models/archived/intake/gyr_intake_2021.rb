...
class Archived::Intake::GyrIntake2021 < Archived::Intake2021
  ...
  enum :bought_health_insurance, { unfilled: 0, yes: 1, no: 2, unsure: 3 }, prefix: :bought_health_insurance
  ...
  enum :had_student_in_family, { unfilled: 0, yes: 1, no: 2, unsure: 3 }, prefix: :had_student_in_family
  ...
  enum :needs_help_2016, { unfilled: 0, yes: 1, no: 2 }, prefix: :needs_help_2016
  enum :needs_help_2017, { unfilled: 0, yes: 1, no: 2 }, prefix: :needs_help_2017
  enum :needs_help_2018, { unfilled: 0, yes: 1, no: 2 }, prefix: :needs_help_2018
  enum :needs_help_2019, { unfilled: 0, yes: 1, no: 2 }, prefix: :needs_help_2019
  enum :needs_help_2020, { unfilled: 0, yes: 1, no: 2 }, prefix: :needs_help_2020
  ...
  enum :spouse_was_on_visa, { unfilled: 0, yes: 1, no: 2 }, prefix: :spouse_was_on_visa
  ...
  enum :was_on_visa, { unfilled: 0, yes: 1, no: 2, unsure: 3 }, prefix: :was_on_visa
