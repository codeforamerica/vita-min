# == Schema Information
#
# Table name: archived_intakes_2022
#
...
# Indexes
#
#  index_archived_intakes_2022_on_hashed_primary_ssn            (hashed_primary_ssn)
#  index_archived_intakes_2022_on_primary_consented_to_service  (primary_consented_to_service)
#  index_archived_intakes_2022_on_primary_drivers_license_id    (primary_drivers_license_id)
#  index_archived_intakes_2022_on_spouse_drivers_license_id     (spouse_drivers_license_id)
#  index_arcint_2022_on_canonical_email_address                 (canonical_email_address)
#  index_arcint_2022_on_client_id                               (client_id)
#  index_arcint_2022_on_completed_at                            (completed_at) WHERE (completed_at IS NOT NULL)
#  index_arcint_2022_on_email_address                           (email_address)
#  index_arcint_2022_on_email_domain                            (email_domain)
#  index_arcint_2022_on_needs_to_flush_searchable_data_set_at   (needs_to_flush_searchable_data_set_at) WHERE (needs_to_flush_searchable_data_set_at IS NOT NULL)
#  index_arcint_2022_on_phone_number                            (phone_number)
#  index_arcint_2022_on_searchable_data                         (searchable_data) USING gin
#  index_arcint_2022_on_sms_phone_number                        (sms_phone_number)
#  index_arcint_2022_on_spouse_email_address                    (spouse_email_address)
#  index_arcint_2022_on_type                                    (type)
#  index_arcint_2022_on_vita_partner_id                         (vita_partner_id)
#
# Foreign Keys
#
...
#
class Archived::Intake::GyrIntake2022 < Archived::Intake2022
  def self.sti_name
    'Intake::GyrIntake'
  end
  ...
  def bank_account
    ...
    type = Archived::BankAccount2022.account_types.keys.include?(bank_account_type) ? bank_account_type : nil
    @bank_account ||= Archived::BankAccount2022.new(account_type: type, bank_name: bank_name, account_number: bank_account_number, routing_number: bank_routing_number)
  end
