...
#
class Archived::Intake::CtcIntake2022 < Archived::Intake2022
  def self.sti_name
    'Intake::CtcIntake'
  end
  ...
  has_one :bank_account, inverse_of: :intake, dependent: :destroy, class_name: 'Archived::BankAccount2022', foreign_key: 'archived_intakes_2022_id'
