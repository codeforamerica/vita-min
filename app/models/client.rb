...
class Client < ApplicationRecord
  ...
  enum :routing_method, { most_org_leads: 0, source_param: 1, zip_code: 2, national_overflow: 3, state: 4, at_capacity: 5, returning_client: 6, itin_enabled: 7, hub_assignment: 8 }, prefix: :routing_method
  enum :still_needs_help, { unfilled: 0, yes: 1, no: 2 }, prefix: :still_needs_help
  enum :experience_survey, { unfilled: 0, positive: 1, neutral: 2, negative: 3 }, prefix: :experience_survey
