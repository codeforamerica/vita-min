...
class User < ApplicationRecord
  ...
  enum client_messages_notification: { yes: 0, no: 1 }, _prefix: :client_messages_notification
  enum client_assignments_notification: { yes: 0, no: 1 }, _prefix: :client_assignments_notification
  enum document_uploads_notification: { yes: 0, no: 1 }, _prefix: :document_uploads_notification
