...
class StateFileId1099RFollowup < ApplicationRecord
  ...
  enum :eligible_income_source, { unfilled: 0, yes: 1, no: 2}, prefix: :eligible_income_source
  enum :income_source, { unfilled: 0, civil_service_employee: 1, police_officer: 2, firefighter: 3, military: 4, none: 5}, prefix: :income_source
  enum :civil_service_account_number, { unfilled: 0, zero_to_four: 1, seven_or_nine: 2, eight: 3}, prefix: :civil_service_account_number
  enum :police_retirement_fund, { unfilled: 0, yes: 1, no: 2}, prefix: :police_retirement_fund
  enum :police_persi, { unfilled: 0, yes: 1, no: 2}, prefix: :police_persi
  enum :firefighter_frf, { unfilled: 0, yes: 1, no: 2}, prefix: :firefighter_frf
  enum :firefighter_persi, { unfilled: 0, yes: 1, no: 2}, prefix: :firefighter_persi
