module InteractionTracking
  ...
  def record_incoming_interaction
    client&.touch(:attention_needed_since, :last_incoming_interaction_at, :last_interaction_at)
  end
  ...
  def record_outgoing_interaction
    client&.update(last_interaction_at: Time.now.to_datetime, attention_needed_since: nil)
  end
