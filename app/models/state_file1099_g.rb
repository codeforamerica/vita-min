...
class StateFile1099G < ApplicationRecord
  ...
  validates :payer_street_address, irs_street_address_type: {  maximum: nil }
  validates :payer_city, irs_street_address_type: {  maximum: nil }
  ...
  validates :recipient_city, presence: true, irs_street_address_type: {  maximum: nil }
  validates :recipient_street_address, presence: true, irs_street_address_type: {  maximum: nil }
