...
class StateFile1099G < ApplicationRecord
  ...
  validates :payer_name, :presence => {message: ->(_object, _data) { I18n.t("errors.attributes.payer_name.blank") }}, format: { with: /(([A-Za-z0-9#-()]|&|') ?)*([A-Za-z0-9#-()]|&|')/.freeze, message: ->(_object, _data) { I18n.t("errors.attributes.payer_name.invalid") }}
