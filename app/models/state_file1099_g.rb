...
class StateFile1099G < ApplicationRecord
  ...
  validates :recipient_street_address_apartment, format: { :with => /[a-zA-Z0-9\-\/ ]+/.freeze, message: I18n.t("errors.attributes.address.street_address.invalid"), allow_blank: true
