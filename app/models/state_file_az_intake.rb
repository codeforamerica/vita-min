...
class StateFileAzIntake < StateFileBaseIntake
  self.ignored_columns = %w[charitable_cash charitable_noncash household_excise_credit_claimed_amt tribal_wages armed_forces_wages bank_name df_data_import_failed_at]
