...
#  form1099r_primary_received_pension         :integer          default("unfilled"), not null
#  form1099r_primary_received_pension_amount  :decimal(12, 2)
#  form1099r_received_military_payment        :integer          default("unfilled"), not null
#  form1099r_received_military_payment_amount :decimal(12, 2)
#  form1099r_spouse_received_pension          :integer          default("unfilled"), not null
#  form1099r_spouse_received_pension_amount   :decimal(12, 2)
...
class StateFileAzIntake < StateFileBaseIntake
  ...
  enum form1099r_received_military_payment: { unfilled: 0, yes: 1, no: 2 }, _prefix: :form1099r_received_military_payment
  enum form1099r_primary_received_pension: { unfilled: 0, yes: 1, no: 2 }, _prefix: :form1099r_primary_received_pension
  enum form1099r_spouse_received_pension: { unfilled: 0, yes: 1, no: 2 }, _prefix: :form1099r_spouse_received_pension
