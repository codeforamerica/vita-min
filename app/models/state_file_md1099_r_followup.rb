...
class StateFileMd1099RFollowup < ApplicationRecord
  ...
  enum :income_source, { unfilled: 0, pension_annuity_endowment: 1, other: 2 }, prefix: :income_source
  enum :service_type, { unfilled: 0, military: 1, public_safety: 2, none: 3 }, prefix: :service_type
end
