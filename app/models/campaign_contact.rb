...
#  sms_notification_opt_in   :boolean          default(FALSE), not null
...
#  index_campaign_contacts_on_lower_email                (lower((email_address)::text)) UNIQUE WHERE (email_address IS NOT NULL)
...
#  index_campaign_contacts_on_sms_phone_number           (sms_phone_number) UNIQUE WHERE (sms_phone_number IS NOT NULL)
