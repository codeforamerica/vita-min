class TaxReturnStateMachine
  ...
  FORWARD_TO_INTERCOM_STATES = [:file_accepted, :file_mailed, :file_not_filing].freeze
  RETURNING_PREVIOUS_YEAR = [:prep_ready_for_prep, :prep_preparing, :review_ready_for_qr, :review_reviewing, :intake_ready_for_call, :review_signature_requested, :file_ready_to_file, :file_efiled, :file_rejected].freeze
