class DependentFlowService
  ...
  def show?
    ...
    when "Ctc::Questions::Dependents::ChildQualifiersController"
      eligibility = child_qualification(except: [:age_test, :financial_support_test, :residence_test, :claimable_test, :home_location_test])
      eligibility.over_qualifying_age_limit? && eligibility.qualifies?
    when "Ctc::Questions::Dependents::ChildExpensesController"
      eligibility = child_qualification(except: [:financial_support_test, :residence_test, :claimable_test, :home_location_test])
      eligibility.qualifies?
    when "Ctc::Questions::Dependents::ChildResidenceController"
      eligibility = child_qualification(except: [:residence_test, :claimable_test, :home_location_test])
    ...
    when "Ctc::Questions::Dependents::ChildCanBeClaimedByOtherController"
      eligibility = child_qualification(except: [:claimable_test, :home_location_test])
      eligibility.qualifies?
    ...
    when "Ctc::Questions::Dependents::RelativeMemberOfHouseholdController"
      ...
      eligibility = relative_qualification(except: [:residence_test, :financial_support_test, :claimable_test, :home_location_test])
    ...
    when "Ctc::Questions::Dependents::RelativeFinancialSupportController"
      ...
      eligibility = relative_qualification(except: [:financial_support_test, :claimable_test, :home_location_test])
      eligibility.qualifies?
    when "Ctc::Questions::Dependents::RelativeQualifiersController"
      return false if child_qualification.qualifies?

      eligibility = relative_qualification(except: [:claimable_test, :home_location_test])
      eligibility.qualifies?
