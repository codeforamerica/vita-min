...
module StateFile
  class StateInformationService
    GETTER_METHODS = [
      ...
      :taxes_owed_mail_followup,
      :tax_payment_option_direct_deposit,
      :tax_payment_option_mail,
    ...
    STATES_INFO = IceNine.deep_freeze!({
      az: {
        ...
        taxes_owed_mail_followup: false,
        tax_payment_option_direct_deposit: "pay_bank",
        tax_payment_option_mail: "pay_mail_online_html",
      ...
      id: {
        ...
        taxes_owed_mail_followup: false,
        tax_payment_option_direct_deposit: "state_file.questions.taxes_owed.edit.pay_bank",
        tax_payment_option_mail: "state_file.questions.taxes_owed.edit.pay_mail_online_html",
      ...
      nj: {
        ...
        taxes_due_dates_payment_info: "",
        taxes_owed_mail_followup: true,
        tax_payment_option_direct_deposit: "state_file.questions.taxes_owed.edit.pay_bank_nj_html",
        tax_payment_option_mail: "state_file.questions.taxes_owed.edit.pay_mail_online_nj",
