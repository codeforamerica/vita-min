    ...
    def hash_for_pdf
      {
        ...
        'Enter Maryland Political Subdivision (See Instruction 6)': @xml_document.at('CityTownOrTaxingArea')&.text,
        ...
        'Text BoTaxpayerSSNx 96': @xml_document.at('ReturnHeaderState Filer Primary USPhone')&.text,
      }
    end
