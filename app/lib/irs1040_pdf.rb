class Irs1040Pdf
  ...
  def hash_for_pdf
    answers = {
        ...
        RefundableCreditsAmt32: @benefits.claimed_recovery_rebate_credit + @benefits.outstanding_ctc_amount,
        TotalPaymentsAmt33: @benefits.claimed_recovery_rebate_credit + @benefits.outstanding_ctc_amount,
        OverpaidAmt34: @benefits.claimed_recovery_rebate_credit + @benefits.outstanding_ctc_amount,
        RefundAmt35: @benefits.claimed_recovery_rebate_credit + @benefits.outstanding_ctc_amount,
