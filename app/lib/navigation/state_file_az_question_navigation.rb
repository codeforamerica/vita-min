  ...
  class StateFileAzQuestionNavigation
    ...
    SECTIONS = [
      ...
      Navigation::NavigationSection.new("state_file.navigation.section_1", [
        ...
        Navigation::NavigationStep.new(StateFile::Questions::EligibleController, true, StateFile::Questions::EligibilityOutOfStateIncomeController),
      ]),
      Navigation::NavigationSection.new("state_file.navigation.section_2", [
        Navigation::NavigationStep.new(StateFile::Questions::ContactPreferenceController, true, StateFile::Questions::EligibilityOutOfStateIncomeController),
        Navigation::NavigationStep.new(StateFile::Questions::PhoneNumberController, true, StateFile::Questions::EligibilityOutOfStateIncomeController),
        Navigation::NavigationStep.new(StateFile::Questions::EmailAddressController, true, StateFile::Questions::EligibilityOutOfStateIncomeController),
        Navigation::NavigationStep.new(StateFile::Questions::VerificationCodeController, true, StateFile::Questions::EligibilityOutOfStateIncomeController),
      ...
      Navigation::NavigationSection.new("state_file.navigation.section_5", [
        ...
        Navigation::NavigationStep.new(StateFile::Questions::AzReviewController, true, StateFile::Questions::AzPrimaryStateIdController),
        Navigation::NavigationStep.new(StateFile::Questions::TaxesOwedController, true, StateFile::Questions::AzPrimaryStateIdController),
        Navigation::NavigationStep.new(StateFile::Questions::TaxRefundController, true, StateFile::Questions::AzPrimaryStateIdController),
        Navigation::NavigationStep.new(StateFile::Questions::EsignDeclarationController, true, StateFile::Questions::AzPrimaryStateIdController), # creates EfileSubmission and transitions to preparing
      ]),
