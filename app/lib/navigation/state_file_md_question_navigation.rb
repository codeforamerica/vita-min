  ...
  class StateFileMdQuestionNavigation < Navigation::StateFileBaseQuestionNavigation
    ...
    SECTIONS = [
      ...
      Navigation::NavigationSection.new("state_file.navigation.section_5", [
        ...
        Navigation::NavigationStep.new(StateFile::Questions::MdPrimaryStateIdController),
        Navigation::NavigationStep.new(StateFile::Questions::MdSpouseStateIdController),
