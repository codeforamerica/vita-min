module SubmissionBuilder
  module Ty2022
    module States
      module Wi
        class IndividualReturnWi1 < SubmissionBuilder::Document
          def document
            document = build_xml_doc('efile:ReturnState', stateSchemaVersion: 'WIIndividual2022V1.0')
          ...
          def schema_file
            File.join(Rails.root, "vendor", "us_states", "WIIndividual2022V0.5", "WIIndividual", "IndividualReturnWI1.xsd")
          end
          ...
          def supported_documents
            supported_docs = [
              {
                xml: SubmissionBuilder::Ty2022::States::Wi::Documents::Form1,
                pdf: nil,
                include: true
              },
            ]
