          ...
          class State1099G < SubmissionBuilder::Document
            ...
            def document
              ...
              build_xml_doc("State1099G", documentId: "State1099G-#{form1099g.id}") do |xml|
                ...
                xml.UnemploymentCompensation form1099g.unemployment_compensation_amount.round.to_i if form1099g.unemployment_compensation_amount.present?
                xml.FederalTaxWithheld form1099g.federal_income_tax_withheld_amount.round.to_i if form1099g.federal_income_tax_withheld_amount.present?
                xml.State1099GStateLocalTaxGrp do
                  xml.StateTaxWithheldAmt form1099g.state_income_tax_withheld_amount.round.to_i if form1099g.state_income_tax_withheld_amount.present?
                  xml.StateAbbreviationCd "NY"
