      ...
      build_xml_doc("FinancialTransaction") do |xml|
        if (@kwargs[:refund_amount] || 0).positive? # REFUND
          ...
          xml.StatePayment do
            ...
            xml.RequestedPaymentDate date_type(@submission.data_source.calculate_date_electronic_withdrawal(form_submitted_time: @submission.created_at)) if @submission.data_source.date_electronic_withdrawal.present?
