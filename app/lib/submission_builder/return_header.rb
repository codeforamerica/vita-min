      ...
      build_xml_doc("ReturnHeaderState") do |xml|
        ...
        xml.Filer do
          xml.Primary do
            ...
            xml.DateSigned date_type_for_timezone(@submission.data_source.primary_esigned_at) if @submission.data_source.ask_for_signature_pin?
          ...
          if @submission.data_source&.spouse.ssn.present? && @submission.data_source&.spouse.first_name.present?
            xml.Secondary do
              ...
              xml.DateSigned date_type_for_timezone(@submission.data_source.spouse_esigned_at) if @submission.data_source.ask_for_signature_pin? && @submission.data_source.ask_spouse_esign?
