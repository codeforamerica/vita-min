      ...
      module Md
        class MdReturnXml < SubmissionBuilder::StateReturn
          ...
          def supported_documents
            ...
            has_income_from_taxable_social_security_benefits = calculated_fields.fetch(:MD502_LINE_11)&.to_i.positive?
            ...
            supported_docs = [
              ...
              },
              {
                ...
                include: has_income_from_taxable_pensions_iras_annuities || has_income_from_taxable_social_security_benefits
              },
              {
                xml: nil,
