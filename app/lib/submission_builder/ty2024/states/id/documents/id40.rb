          ...
          class Id40 < SubmissionBuilder::Document
            ...
            def document
              build_xml_doc("Form40") do |xml|
                ...
                xml.EstimatedTaxPaymentCurrentYear calculated_fields.fetch(:ID40_LINE_47) if Flipper.enabled?(:extension_period) && calculated_fields.fetch(:ID40_LINE_47).positive?
