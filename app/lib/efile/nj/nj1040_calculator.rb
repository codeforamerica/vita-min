  ...
  module Nj
    class Nj1040Calculator < ::Efile::TaxCalculator
      ...
      def calculate
        ...
        @intake.update_attribute(:NJ1040_LINE_7_SELF, line_7_self_checkbox)
        set_line(:NJ1040_LINE_7_SPOUSE, :line_7_spouse_checkbox)
        @intake.update_attribute(:NJ1040_LINE_7_SPOUSE, line_7_spouse_checkbox)
        ...
        @intake.update_attribute(:NJ1040_LINE_12_COUNT, line_12_count.to_i)
        set_line(:NJ1040_LINE_13, :calculate_line_13)
        set_line(:NJ1040_LINE_15, :calculate_line_15)
        @intake.update_attribute(:NJ1040_LINE_15, calculate_line_15.to_i)
        set_line(:NJ1040_LINE_16A, :calculate_line_16a)
        @intake.update_attribute(:NJ1040_LINE_16A, calculate_line_16a.to_i)
        set_line(:NJ1040_LINE_16B, :calculate_line_16b)
        @intake.update_attribute(:NJ1040_LINE_16B, calculate_line_16b.to_i)
        set_line(:NJ1040_LINE_27, :calculate_line_27)
        set_line(:NJ1040_LINE_29, :calculate_line_29)
        @intake.update_attribute(:NJ1040_LINE_29, calculate_line_29.to_i)
        set_line(:NJ1040_LINE_31, :calculate_line_31)
        @intake.update_attribute(:NJ1040_LINE_31, calculate_line_31.to_i)
        ...
        @intake.update_attribute(:NJ1040_LINE_41, calculate_line_41.to_i)
        set_line(:NJ1040_LINE_42, :calculate_line_42)
        @intake.update_attribute(:NJ1040_LINE_42, calculate_line_42.to_i)
        set_line(:NJ1040_LINE_43, :calculate_line_43)
        @intake.update_attribute(:NJ1040_LINE_43, calculate_line_43.to_i)
        ...
        @intake.update_attribute(:NJ1040_LINE_51, calculate_line_51.to_i)
        ...
        @intake.update_attribute(:NJ1040_LINE_56, calculate_line_56.to_i)
        set_line(:NJ1040_LINE_57, :calculate_line_57)
        set_line(:NJ1040_LINE_58, :calculate_line_58)
        @intake.update_attribute(:NJ1040_LINE_58, calculate_line_58.to_i)
        set_line(:NJ1040_LINE_58_IRS, :calculate_line_58_irs)
        @intake.update_attribute(:NJ1040_LINE_58_IRS, calculate_line_58_irs)
        set_line(:NJ1040_LINE_59, :calculate_line_59)
        @intake.update_attribute(:NJ1040_LINE_59, calculate_line_59.to_i)
        set_line(:NJ1040_LINE_60, :calculate_line_60)
        set_line(:NJ1040_LINE_61, :calculate_line_61)
        @intake.update_attribute(:NJ1040_LINE_61, calculate_line_61.to_i)
        ...
        @intake.update_attribute(:NJ1040_LINE_64, calculate_line_64.to_i)
        set_line(:NJ1040_LINE_65_DEPENDENTS, :number_of_dependents_age_5_younger)
        @intake.update_attribute(:NJ1040_LINE_65_DEPENDENTS, number_of_dependents_age_5_younger.to_i)
        set_line(:NJ1040_LINE_65, :calculate_line_65)
        @intake.update_attribute(:NJ1040_LINE_65, calculate_line_65.to_i)
