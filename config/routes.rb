  ...
  constraints(Routes::GyrDomain.new) do
    ...
    scope '(:locale)', locale: /#{I18n.available_locales.join('|')}/ do
      ...
      namespace :hub do
        ...
        resources :efile_submissions, module: "state_file", path: "state-file/efile-submissions", only: [:index], controller: 'efile_submissions', as: :state_file_efile_submissions
