...
Rails.application.configure do
  ...
  # Keep GYR and FYST 'open' until the end of the year
  # use the session toggles if you want to emulate/test 'closed' behaviors
  config.end_of_intake = Time.find_zone('America/New_York').parse('2024-12-31 23:59:59')
  config.state_file_end_of_new_intakes = Time.find_zone('America/New_York').parse('2024-12-31 23:59:59')
end
