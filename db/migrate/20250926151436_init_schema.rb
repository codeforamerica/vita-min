class InitSchema < ActiveRecord::Migration[7.1]
  def up
    ...
    create_table "archived_bank_accounts_2021" do |t|
    ...
    create_table "archived_dependents_2021" do |t|
    ...
    create_table "archived_intakes_2021" do |t|
    ...
    create_table "state_file_az1099_r_followups" do |t|
      t.datetime "created_at", null: false
    ...
    create_table "state_file_id1099_r_followups" do |t|
    ...
    create_table "state_file_md1099_r_followups" do |t|
      t.datetime "created_at", null: false
      t.integer "income_source", default: 0, null: false
      t.integer "service_type", default: 0, null: false
      t.datetime "updated_at", null: false
    ...
    create_table "state_file_nc1099_r_followups" do |t|
    ...
    create_table "state_file_nj1099_r_followups" do |t|
      t.datetime "created_at", null: false
      t.integer "income_source", default: 0, null: false
      t.datetime "updated_at", null: false
    end
