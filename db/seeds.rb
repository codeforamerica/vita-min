...
OutgoingTextMessage.create!(client: client, body: "Hey client, how is it going", user: user, sent_at: 3.days.ago, to_phone_number: "+14155551212")
OutgoingTextMessage.create!(client: client, body: "Hey client, how is it going", user: user, sent_at: 2.days.ago, to_phone_number: "+14155551212")
OutgoingTextMessage.create!(client: client, body: "Hey client, how is it going", user: user, sent_at: DateTime.now, to_phone_number: "+14155551212")
