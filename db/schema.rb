...
ActiveRecord::Schema[7.0].define(version: 2023_01_17_223425) do
  ...
  create_table "archived_bank_accounts_2022", force: :cascade do |t|
    t.text "account_number"
    t.integer "account_type"
    ...
    t.string "routing_number"
    t.datetime "updated_at", null: false
    t.index ["archived_intakes_2022_id"], name: "index_archived_bank_accounts_2022_on_archived_intakes_2022_id"
    t.index ["hashed_account_number"], name: "index_archived_bank_accounts_2022_on_hashed_account_number"
    t.index ["routing_number"], name: "index_archived_bank_accounts_2022_on_routing_number"
  end
  ...
  create_table "archived_dependents_2022", force: :cascade do |t|
    t.bigint "archived_intakes_2022_id", null: false
    ...
    t.integer "was_married", default: 0, null: false
    t.integer "was_student", default: 0, null: false
    t.index ["archived_intakes_2022_id"], name: "index_archived_dependents_2022_on_archived_intakes_2022_id"
    t.index ["creation_token"], name: "index_archived_dependents_2022_on_creation_token"
  end
  ...
  create_table "archived_intakes_2022", force: :cascade do |t|
    t.string "additional_info"
    t.integer "adopted_child", default: 0, null: false
    ...
    t.boolean "with_vita_approved_taxpayer_id", default: false
    t.string "zip_code"
    t.index ["canonical_email_address"], name: "index_arcint_2022_on_canonical_email_address"
    t.index ["client_id"], name: "index_arcint_2022_on_client_id"
    t.index ["completed_at"], name: "index_arcint_2022_on_completed_at", where: "(completed_at IS NOT NULL)"
    t.index ["email_address"], name: "index_arcint_2022_on_email_address"
    t.index ["email_domain"], name: "index_arcint_2022_on_email_domain"
    t.index ["hashed_primary_ssn"], name: "index_archived_intakes_2022_on_hashed_primary_ssn"
    t.index ["needs_to_flush_searchable_data_set_at"], name: "index_arcint_2022_on_needs_to_flush_searchable_data_set_at", where: "(needs_to_flush_searchable_data_set_at IS NOT NULL)"
    t.index ["phone_number"], name: "index_arcint_2022_on_phone_number"
    t.index ["primary_consented_to_service"], name: "index_archived_intakes_2022_on_primary_consented_to_service"
    t.index ["primary_drivers_license_id"], name: "index_archived_intakes_2022_on_primary_drivers_license_id"
    t.index ["searchable_data"], name: "index_arcint_2022_on_searchable_data", using: :gin
    t.index ["sms_phone_number"], name: "index_arcint_2022_on_sms_phone_number"
    t.index ["spouse_drivers_license_id"], name: "index_archived_intakes_2022_on_spouse_drivers_license_id"
  ...
  add_foreign_key "archived_bank_accounts_2022", "archived_intakes_2022"
  add_foreign_key "archived_dependents_2021", "archived_intakes_2021"
  add_foreign_key "archived_dependents_2022", "archived_intakes_2022"
