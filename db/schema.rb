...
ActiveRecord::Schema[7.1].define(version: 2026_03_25_165313) do
  ...
  create_table "campaign_emails", force: :cascade do |t|
    ...
    t.index ["campaign_contact_id", "message_name"], name: "index_unique_start_of_season_outreach_per_contact", unique: true, where: "((message_name)::text = 'start_of_season_outreach'::text)"
