...
RSpec.describe ClientEmailVerificationRequestJob, type: :job do
  before do
  ...
  describe "#perform" do
    it "requests an email login from the client logins service" do
      ClientEmailVerificationRequestJob.perform_now(email_address: "client@example.com", visitor_id: "87h2897gh2", locale: "es")
