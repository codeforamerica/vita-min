...
describe SendDiySupportEmailJob do
  ...
  before do
    allow(DiyIntakeEmailMailer).to receive(:high_support_message).and_return(mailer)
  ...
  it 'sends an email' do
    ...
    expect(DiyIntakeEmailMailer).to have_received(:high_support_message).with(diy_intake_email: diy_intake_email)
