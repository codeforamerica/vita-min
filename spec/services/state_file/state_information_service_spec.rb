...
describe StateFile::StateInformationService do
  describe ".active_state_codes" do
    it "returns the list of state codes as strings" do
      expect(described_class.active_state_codes).to match_array ["az", "nc", "nj", "ny", "id"]
    end
  end
  ...
  describe ".state_intake_classes" do
    it "returns an array of the intake classes" do
      expect(described_class.state_intake_classes).to match_array [StateFileAzIntake, StateFileNcIntake, StateFileNjIntake, StateFileNyIntake, StateFileIdIntake]
    end
  end

  describe ".state_intake_class_names" do
    it "returns an array of the intake classes as strings" do
      expect(described_class.state_intake_class_names).to match_array ["StateFileAzIntake", "StateFileNcIntake", "StateFileNjIntake", "StateFileNyIntake", "StateFileIdIntake"]
    end
  end
