...
describe ReplacementParametersService do
  let(:client) { create :client, intake: create(:intake, preferred_name: "Preferred Name"), tax_returns: [create(:gyr_tax_return)], vita_partner: (create :organization, name: "Koala County VITA") }
  ...
  context "<<Client.LoginLink>>" do
    ...
    context "with a ctc intake" do
      let(:client) { create :client, intake: create(:ctc_intake, preferred_name: "Preferred Name"), tax_returns: [create(:ctc_tax_return)], vita_partner: (create :organization, name: "Koala County VITA") }
