...
describe ReplacementParametersService do
  let(:client) { create :client, intake: build(:intake, preferred_name: "Preferred Name"), tax_returns: [build(:gyr_tax_return)], vita_partner: (create :organization, name: "Koala County VITA") }
  ...
  before do
    @test_environment_credentials.merge!(twilio: { gyr: { voice_phone_number: "+13444444444" } })
  end
