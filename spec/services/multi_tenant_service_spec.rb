...
describe MultiTenantService do
  ...
  describe "#filing_years" do
    ...
    it "returns valid filing years for gyr when using DateTime.now" do
    ...
    it "returns valid filing years for gyr when passed a time parameter that is past the deadline for a previous year" do
      fake_time = Rails.configuration.tax_year_filing_seasons[2020][1] + 3.years + 1.day
