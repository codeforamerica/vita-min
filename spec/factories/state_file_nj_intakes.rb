...
FactoryBot.define do
  factory :state_file_nj_intake do
    ...
    trait :df_data_irs_test_w2_withholding_amt_bug do
      raw_direct_file_data { StateFile::DirectFileApiResponseSampleService.new.read_xml('nj_irs_test_w2_withholding_amt_bug') }
      raw_direct_file_intake_data { StateFile::DirectFileApiResponseSampleService.new.read_json('nj_irs_test_w2_withholding_amt_bug') }
    end
