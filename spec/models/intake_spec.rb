...
describe Intake do
  context "custom readers for encrypted attrs cutover" do
    describe "#primary_ssn" do
      let!(:intake) { build :intake, attr_encrypted_primary_ssn: "123456789", primary_ssn: nil }
    ...
    describe "#spouse_ssn" do
      let!(:intake) { build :intake, attr_encrypted_spouse_ssn: "123456789", spouse_ssn: nil }
      ...
      it "can write spouse_ssn to the new encrypted field" do
        ...
        expect(intake.spouse_last_four_ssn).to eq "6898"
      end
    end
    ...
    describe "#primary_last_four_ssn" do
      ...
      it "updates when primary_ssn is written to" do
        expect(intake.primary_ssn).to eq "123456789"
        expect(intake.read_attribute(:primary_last_four_ssn)).to eq "6789"
        expect(intake.primary_last_four_ssn).to eq "6789"
      end
    end

    describe "#spouse_last_four_ssn" do
      let!(:intake) { create :intake, spouse_ssn: "123456787" }

      it "is an encrypted attribute" do
        expect(intake.encrypted_attribute?(:spouse_last_four_ssn)).to eq true
      end

      it "updates when spouse_ssn is written to" do
        expect(intake.spouse_ssn).to eq "123456787"
    ...
    describe "#bank_name" do
      let!(:intake) { create :intake, attr_encrypted_bank_name: "Bank of Two Melons", bank_name: nil }
    ...
    describe "#bank_routing_number" do
      let!(:intake) { create :intake, attr_encrypted_bank_routing_number: "123456878", bank_routing_number: nil }
    ...
    describe "#bank_account_number" do
      let!(:intake) { create :intake, attr_encrypted_bank_account_number: "123456878", bank_account_number: nil }
    ...
    describe "#primary_ip_pin" do
      let!(:intake) { build :intake, attr_encrypted_primary_ip_pin: "12345", primary_ip_pin: nil }
    ...
    describe "#spouse_ip_pin" do
      let!(:intake) { create :intake, attr_encrypted_spouse_ip_pin: "123456", spouse_ip_pin: nil }
    ...
    describe "#spouse_signature_pin" do
      let!(:intake) { create :intake, attr_encrypted_spouse_signature_pin: "12345", spouse_signature_pin: nil }
    ...
    describe "#primary_signature_pin" do
      let!(:intake) { create :intake, attr_encrypted_primary_signature_pin: "12345", primary_signature_pin: nil }
