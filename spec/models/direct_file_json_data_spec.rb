...
describe DirectFileJsonData do
  ...
  describe "for a single filer" do
    ...
    it "can read value" do
      ...
      expect(direct_file_json_data.primary_filer.ssnNotValidForEmployment).to eq(nil)
    end
  end
  ...
  describe "for a mfj filer" do
    ...
    it "can read value" do
      ...
      expect(direct_file_json_data.spouse_filer.ssnNotValidForEmployment).to eq(nil)
    end
  end
