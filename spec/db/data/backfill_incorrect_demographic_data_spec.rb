...
require_relative "../../../db/data/20230405203123_correct_demographic_data_on_intake"

describe "CorrectDemographicDataOnIntake" do
  ...
  it "resets the set of answers for each filer to nil if the whole set (including prefer not to answer) was true" do
    CorrectDemographicDataOnIntake.new.up
    ...
    expect(botched_intake_partial.demographic_primary_asian).to eq true
