...
RSpec.feature "Logging in with an existing account" do
  ...
  scenario "signing in with email" do
    ...
    expect(mail.html_part.body.to_s).to include("Your six-digit code FileYourStateTaxes verification code is: #{verification_code}. This code will expire after two days.")
