...
RSpec.feature "Going through the eligibility screener" do
  ...
  context "residency requirement" do
    it "NY: shows them the offboarding page if they don't meet the residency requirement" do
      ...
      expect(page).to have_text "First, let's see if you can use this service to file your taxes"
      ...
      expect(page).to have_text "Unfortunately, you can't use this service this year. Don't worry, there are other filing options."
    end
