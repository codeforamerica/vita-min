...
RSpec.feature "CTC Intake", :js, :active_job, requires_default_vita_partners: true do
  module CtcPortalHelper
    def log_in_to_ctc_portal
      ...
      expect(mail.html_part.body.to_s).to have_text("Your six-digit code GetCTC verification code is: ")
      code = mail.html_part.body.to_s.match(/Your six-digit code GetCTC verification code is: (\d+)/)[1]
