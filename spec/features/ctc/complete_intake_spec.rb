...
RSpec.feature "CTC Intake", :flow_explorer_screenshot_i18n_friendly, active_job: true do
  ...
  scenario "client who has filed in 2019" do
    ...
    expect(page).to have_selector("h1", text: I18n.t('views.ctc.questions.prior_year_agi.title'))
    fill_in I18n.t('views.ctc.questions.prior_year_agi.label'), with: '$12,340'
    click_on I18n.t('general.continue')
    ...
    expect(page).to have_selector("h1", text: I18n.t('views.ctc.questions.spouse_prior_year_agi.title', prior_tax_year: Rails.application.config.current_tax_year - 1))
    fill_in I18n.t('views.ctc.questions.prior_year_agi.label'), with: '4,567'
    click_on I18n.t('general.continue')
