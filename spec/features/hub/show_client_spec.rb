...
RSpec.describe "a user viewing a client" do
  ...
  context "user without admin access, but is coalition lead for client organization" do
    ...
    let!(:intake_with_ssn_match) { create :intake, primary_consented_to_service_at: DateTime.now, primary_consented_to_service: "yes", primary_ssn: primary_ssn, client: create(:client_with_tax_return_state, tax_return_state: "intake_ready") }
