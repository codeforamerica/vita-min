...
RSpec.describe "Selecting clients for bulk actions", active_job: true do
  ...
  let!(:client_es) { create :client_with_intake_and_return, tax_return_state: "prep_info_requested", vita_partner: old_org }
  let!(:client_en) { create :client_with_intake_and_return, tax_return_state: "intake_reviewing", vita_partner: old_org }
  before do
    login_as user
