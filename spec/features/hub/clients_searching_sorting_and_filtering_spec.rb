...
RSpec.describe "searching, sorting, and filtering clients" do
  context "as an admin user" do
    ...
    context "with existing clients" do
      ...
      let!(:betty_intake_in_progress) { create :client, vita_partner: vita_partner_other, intake: (create :intake, preferred_name: "Betty Banana", created_at: 2.days.ago, state_of_residence: "TX"), last_outgoing_communication_at: Time.new(2021, 5, 3), first_unanswered_incoming_interaction_at: Time.new(2021, 4, 28), tax_returns: [(create :tax_return, year: 2018, status: "intake_in_progress", assigned_user: mona_user)] }
