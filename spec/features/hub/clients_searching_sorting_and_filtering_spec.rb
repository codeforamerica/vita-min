...
RSpec.describe "searching, sorting, and filtering clients" do
  context "as an admin user" do
    ...
    context "with existing clients" do
      ...
      let!(:marty_ctc) { create :client, vita_partner: vita_partner_ctc, intake: (create :ctc_intake, preferred_name: "Marty Mango", created_at: 5.days.ago, state_of_residence: "ME"), last_outgoing_communication_at: Time.new(2021, 5, 2), first_unanswered_incoming_interaction_at: Time.new(2021, 5, 5), tax_returns: [(create :ctc_tax_return, :prep_ready_for_prep)] }
