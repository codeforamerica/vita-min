...
RSpec.describe ApplicationController do
  ...
  describe "#ensure_non_admins_reset_passwords_when_forced" do
    ...
    context "when a non-admin is logged in" do
      before do
        ...
        non_admin_user.update!(forced_password_reset_at: nil)
      end

      it "redirects to change the password" do
        get :index
      ...
      it "does not redirect if the password was already set" do
        non_admin_user.update!(forced_password_reset_at: DateTime.now)
        get :index
