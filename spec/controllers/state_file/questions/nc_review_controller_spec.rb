...
RSpec.describe StateFile::Questions::NcReviewController do
  ...
  describe "#edit" do
    ...
    it "shows detailed return information" do
      ...
      allow_any_instance_of(Efile::Nc::D400ScheduleSCalculator).to receive(:calculate_line_20).and_return(4_200)
      ...
      allow_any_instance_of(Efile::Nc::D400ScheduleSCalculator).to receive(:calculate_line_21).and_return(2_112)
      ...
      expect(page_content).to include I18n.t("state_file.questions.nc_review.edit.benefits_vested_pensions")
      expect(page_content).to include "$4,200"
      expect(page_content).to include I18n.t("state_file.questions.nc_review.edit.service_members")
      expect(page_content).to include "$2,112"
