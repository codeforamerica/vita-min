...
RSpec.describe Hub::UnattendedClientsController, type: :controller do
  describe "#index" do
    ...
    context "as an authenticated team member" do
      ...
      let!(:client_within_sla) { create :client_with_intake_and_return, tax_return_state: "intake_ready", first_unanswered_incoming_interaction_at: 2.business_days.ago, last_internal_or_outgoing_interaction_at: 11.business_days.ago, vita_partner: site }
      let!(:four_day_completed_status) { create :client_with_intake_and_return, tax_return_state: "file_accepted", first_unanswered_incoming_interaction_at: 4.business_days.ago, last_internal_or_outgoing_interaction_at: 11.business_days.ago, vita_partner: site}
      let!(:four_day_breach_client) { create :client_with_intake_and_return, tax_return_state: "intake_ready", first_unanswered_incoming_interaction_at: 4.business_days.ago, last_internal_or_outgoing_interaction_at: 11.business_days.ago, vita_partner: site }
      let!(:six_day_breach_client) { create :client_with_intake_and_return, tax_return_state: "intake_ready", first_unanswered_incoming_interaction_at: 6.business_days.ago, last_internal_or_outgoing_interaction_at: 11.business_days.ago, vita_partner: site }
      let!(:ten_day_breach_client_done_filing) do
        ...
        create :gyr_tax_return, :file_mailed, client: c
        c
      end
      let!(:ten_day_breach_client_half_done_filing) do
        c = create :client,
               ...
               vita_partner: site,
               intake: build(:intake)
        create :tax_return, :file_not_filing, year: 2018, client: c
        create :tax_return, :review_ready_for_call, year: 2019, client: c
        c
      end
      before do
        sign_in user
      ...
      context "tax return count" do
        let!(:over_pagination_clients) { create_list :client_with_intake_and_return, 41, tax_return_state: "intake_ready", first_unanswered_incoming_interaction_at: 6.business_days.ago, last_internal_or_outgoing_interaction_at: 11.business_days.ago, vita_partner: site }
        let(:params) do
          {
            page: "1"
          }
