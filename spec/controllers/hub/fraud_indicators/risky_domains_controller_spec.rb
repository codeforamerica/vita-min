...
describe Hub::FraudIndicators::RiskyDomainsController do
  ...
  describe "#index" do
    ...
    context "when logged in" do
      ...
      before do
        sign_in user
        Fraud::Indicators::Domain.create(safe: true, name: "something.com", activated_at: DateTime.now)
        Fraud::Indicators::Domain.create(risky: true, name: "something-else.com", activated_at: nil)
        Fraud::Indicators::Domain.create(risky: true, name: "another-thing.com", activated_at: DateTime.now)
      end
  ...
  describe "#update" do
    let!(:indicator) { Fraud::Indicators::Domain.create(risky: true, name: "example.com") }
    let(:params) do
      { id: indicator.id }
    end
