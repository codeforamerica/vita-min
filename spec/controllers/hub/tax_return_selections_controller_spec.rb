...
RSpec.describe Hub::TaxReturnSelectionsController do
  ...
  let(:clients) { create_list :client_with_intake_and_return, 3, vita_partner: organization, tax_return_state: "file_efiled" }
  ...
  describe "#new" do
    let!(:clients) { create_list :client_with_intake_and_return, 30, vita_partner: organization, tax_return_state: "file_efiled" }
