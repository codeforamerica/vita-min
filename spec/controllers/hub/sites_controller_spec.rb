...
RSpec.describe Hub::SitesController, type: :controller do
  ...
  describe "#new" do
    ...
    context "as an authenticated admin user" do
      ...
      it "has a default organization and a list of organizations" do
        ...
        expect(assigns(:site).organization).to eq organization
  ...
  describe "#create" do
    ...
    context "as an authenticated admin user" do
      ...
      it "creates the site with attributes and redirects to the input organization edit page" do
        expect do
        ...
        expect(site.organization).to eq other_organization
  ...
  describe "#edit" do
    ...
    let(:params) do
      { organization_id: organization.id, id: site.id }
    end
