...
RSpec.describe Hub::DocumentsController, type: :controller do
    ...
    context "as an authenticated user" do
      ...
      context "sorting and ordering" do
        ...
        context "with sort param of tax_return - sorts by tax_return year" do
          ...
          let!(:document_2024) { create :document, created_at: 1.hour.ago, display_name: "Zebra doc", client: client, tax_return: tax_return_1 }
          let!(:document_2019) { create :document, created_at: 1.minute.ago, display_name: "Alligator doc", client: client, tax_return: tax_return_2 }
          ...
          it "orders documents by that column" do
            ...
            expect(assigns(:documents)).to eq [document_2019, document_2024]
          end
        end
  ...
  describe "#create" do
    ...
    context "with an authenticated user" do
      ...
      it "appends the document to the client's documents list and redirects to confirm document upload page" do
        expect {
