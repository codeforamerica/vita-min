...
RSpec.describe Hub::AssignedClientsController do
  describe "#index" do
    ...
    context "as an authenticated user" do
      ...
      let!(:assigned_to_me_two_trs) { create :client, vita_partner: organization, intake: (build :intake), tax_returns: [(create :tax_return, :review_reviewing, assigned_user: user, year: 2019), (create :tax_return, :intake_ready_for_call, assigned_user: user)] }
