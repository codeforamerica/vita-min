  ...
  describe "#update" do
    ...
    context "as an authenticated user" do
      ...
      context "with valid params" do
        let!(:selected_client) { create :client, intake: (build :intake), vita_partner: organization, tax_returns: [(build :gyr_tax_return, tax_return_selections: [tax_return_selection])] }
