...
RSpec.describe Hub::BulkActions::TurnRedDotFlagOffController do
  ...
  describe "#update" do
    ...
    context "as an authenticated user" do
      ...
      it "creates a notification and enqueues a job disable the flag" do
        expect do
        ...
        expect(user.notifications.last.notifiable.task_type).to eq("turn_red_dot_flag_off")
