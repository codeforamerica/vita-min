...
RSpec.describe Questions::TriageBacktaxesYearsController do
  describe "#update" do
    context "with valid params" do
      ...
      context "with triage answers that are within the filing limit and with at least some documents" do
        let(:triage) { create(:triage, income_level: "hh_1_to_25100", doc_type: "some_copies") }
