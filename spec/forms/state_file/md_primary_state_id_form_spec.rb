...
RSpec.describe StateFile::MdPrimaryStateIdForm do
  let!(:intake) { create :state_file_md_intake, primary_state_id: nil }
  let(:valid_params) do
    {
  ...
  describe "#save" do
    context "when params valid" do
      it "saves values" do
        ...
        expect(intake.primary_state_id.state).to eq "MD"
      end
    end
  end
