...
RSpec.describe StateFile::NySpouseStateIdForm do
  ...
  describe "#save" do
    context "when params valid" do
      it "saves values" do
        ...
        expect(intake.spouse_state_id.state).to eq "NY"
        expect(intake.spouse_state_id.first_three_doc_num).to eq "ABC"
      end
    end
  end
