  ...
  describe "#valid?" do
    ...
    context "when Idaho" do
      ...
      context "when value is zero" do
        it "payment_msg is the Idaho specific payment_validation_message" do
          form = described_class.new(intake, invalid_params)
          expect(form).not_to be_valid
          ...
          expect(form.payment_msg).to eq I18n.t("state_file.questions.extension_payments.id.payment_validation_message")
        end
      end
