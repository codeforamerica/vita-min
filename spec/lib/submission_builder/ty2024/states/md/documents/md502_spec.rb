    ...
    describe ".document" do
      ...
      context "tax computation section" do
        ...
        it "leaves amounts blank if method is not standard" do
          ...
          expect(xml.at("Form502 StateTaxComputation PovertyLevelCredit").text).to be_nil
          expect(xml.at("Form502 StateTaxComputation TotalCredits").text).to be_nil
          expect(xml.at("Form502 StateTaxComputation StateTaxAfterCredits").text).to be_nil
        end
      end
