...
RSpec.describe OmniAuth::Strategies::Zendesk do
  ...
  context "client options" do
    it "should use the zendesk eitc domain" do
      expect(subject.options.client_options.site).to eq("https://eitc.zendesk.com/")
      expect(subject.options.client_options.authorize_url).to eq("https://eitc.zendesk.com/oauth/authorizations/new")
