...
describe AppliedStandardDeduction do
  ...
  describe "additional blind deduction" do
    let(:tax_return) { create :tax_return, filing_status: filing_status, year: 2021, client: create(:client, intake: create(:intake, was_blind: was_blind, spouse_was_blind: spouse_was_blind)) }
  ...
  describe "additional age deduction" do
    let(:tax_return) { create :tax_return, filing_status: filing_status, year: 2021, client: create(:client, intake: create(:intake, primary_birth_date: primary_birth_date, spouse_birth_date: spouse_birth_date)) }
    let(:filing_status) { "single" }
