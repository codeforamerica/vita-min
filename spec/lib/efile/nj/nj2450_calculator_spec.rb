...
describe Efile::Nj::Nj2450Calculator do
  ...
  context "primary" do
    context "column a" do
      context "multiple w2s that individually do not exceed EXCESS_UI_WF_SWF_MAX and total more than EXCESS_UI_WF_SWF_MAX" do 
    ...
    context "column c" do
      context "multiple w2s that individually do not exceed EXCESS_FLI_MAX and total more than EXCESS_FLI_MAX" do 
