...
describe Efile::Md::Md502CrCalculator do
  ...
  let(:instance) { main_calculator.instance_variable_get(:@md502_cr) }

  describe "#calculate_part_b_line_3" do
    before do
  ...
  describe '#calculate_part_b_line_4' do
    let(:filing_status) { "single" }
  ...
  describe '#calculate_part_m_line_1' do
