    ...
    context "with a complete intake record and disclose consented" do
      ...
      it "fills out answers from the DB into the pdf" do
        ...
        expect(result).to include(
                            ...
                            "form1[0].page2[0].IncomeIncludedComment[0].IncomeIncludedComments[0]" => "Other money received during the year includes: garden gnoming \r---\r",
                            ...
                            "form1[0].page5[0].AdditionalComments[0].AdditionalNotesComments[0]" => "if there is another gnome living in my garden but only i have an income, does that make me head of household?\r\r",
