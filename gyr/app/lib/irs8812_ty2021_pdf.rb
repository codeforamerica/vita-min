  ...
  def hash_for_pdf
    {
      ...
      USHomeInd13a: xml_value_to_bool(@xml_document.at("MainHomeInUSOverHalfYrInd"), "CheckboxType") ? "1" : "Off", #13a
      PRResidentInd13b: xml_value_to_bool(@xml_document.at("BonaFidePRResidentInd"), "CheckboxType") ? "1" : "Off", #13b
