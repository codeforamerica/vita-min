...
RSpec.describe Hub::BulkClientMessagesController do
  ...
  describe "#show" do
    let!(:successful_client) { create :client_with_intake_and_return, vita_partner: organization, tax_return_state: "file_efiled" }
    let!(:failed_client) { create :client_with_intake_and_return, vita_partner: organization, tax_return_state: "file_efiled" }
    let!(:in_progress_client) { create :client_with_intake_and_return, vita_partner: organization, tax_return_state: "file_efiled" }
    ...
    context "as an authenticated user" do
      ...
      context "with a 'failed' param" do
        ...
        context "when the user cannot access all of the clients" do
          render_views
          let!(:inaccessible_client) { create :client_with_intake_and_return, tax_return_state: "file_efiled" }
