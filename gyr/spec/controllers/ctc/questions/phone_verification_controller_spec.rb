...
describe Ctc::Questions::PhoneVerificationController, requires_default_vita_partners: true do
  ...
  let(:client) { create :client, intake: (build :ctc_intake, sms_phone_number: "+15125551234", visitor_id: visitor_id, locale: locale), tax_returns: [build(:ctc_tax_return, :intake_before_consent)] }
