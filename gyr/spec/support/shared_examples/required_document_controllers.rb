shared_examples :a_required_document_controller do |person: :unfilled|
  context "requiring an upload" do
    ...
    context "when they have uploaded one document" do
      before do
        create :document, intake: intake, document_type: controller.document_type_key, person: person
      end
